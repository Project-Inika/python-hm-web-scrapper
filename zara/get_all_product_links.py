...
"""
This script is to extract all the product links and store it inside into the folder category files and also store all links in text file all zara product link.txt
use extract_all_data to extract product details.
"""
...
def saveCategoryProductLinksToFile(category_dir, filename = "all_zara_product_links.txt"):
    files = os.listdir(category_dir)
    list_products = []

    for i in files:
        file_path = os.path.join(category_dir, i)
...
def main():
    ...
    saveCategoryProductLinksToFile(category_dir)
